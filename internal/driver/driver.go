...
import (
	...
	"github.com/winc-link/hummingbird-opcua-driver/internal/client"
	"github.com/winc-link/hummingbird-opcua-driver/internal/device"
...
// NewOpcuaProtocolDriver ModbusTcp协议驱动
func NewOpcuaProtocolDriver(sd *service.DriverService) *ModbusTcpProtocolDriver {
	loadDevices(sd)
	ctx := context.Background()
	opcuaClient, err := client.NewOpcuaClient(ctx)
	if err != nil {
		sd.GetLogger().Error("new opcuaClient client err:", err.Error())
	}
